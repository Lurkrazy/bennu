...
extern "C" __global__ void __launch_bounds__(64) main_kernel(half* __restrict__ A, half* __restrict__ W, half* __restrict__ conv2d_nchw) {
  ...
  for (int ax0_ax1_ax3_ax4_ax5_fused_0 = 0; ax0_ax1_ax3_ax4_ax5_fused_0 < 4; ++ax0_ax1_ax3_ax4_ax5_fused_0) {
      int4 v__1 = make_int4((((((((ax0_ax1_ax3_ax4_ax5_fused_0 * 200704) + ((((int)threadIdx.x) & 3) * 50176)) + (((int)blockIdx.y) * 256)) + (((int)blockIdx.x) * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) >> 2)))+(12544*0), (((((((ax0_ax1_ax3_ax4_ax5_fused_0 * 200704) + ((((int)threadIdx.x) & 3) * 50176)) + (((int)blockIdx.y) * 256)) + (((int)blockIdx.x) * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) >> 2)))+(12544*1), (((((((ax0_ax1_ax3_ax4_ax5_fused_0 * 200704) + ((((int)threadIdx.x) & 3) * 50176)) + (((int)blockIdx.y) * 256)) + (((int)blockIdx.x) * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) >> 2)))+(12544*2), (((((((ax0_ax1_ax3_ax4_ax5_fused_0 * 200704) + ((((int)threadIdx.x) & 3) * 50176)) + (((int)blockIdx.y) * 256)) + (((int)blockIdx.x) * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) >> 2)))+(12544*3));
      half4 v__2 = *(half4*)(((half*)buf_dyn_shmem) + ((((ax0_ax1_ax3_ax4_ax5_fused_0 * 256) + (((int)threadIdx.y) * 128)) + (((int)threadIdx.x) * 4)) + 640));
      conv2d_nchw[v__1.x] = v__2.x;
      conv2d_nchw[v__1.y] = v__2.y;
      conv2d_nchw[v__1.z] = v__2.z;
      conv2d_nchw[v__1.w] = v__2.w;
  }
}
